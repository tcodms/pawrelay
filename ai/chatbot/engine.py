...
class ChatbotEngine:
    ...
    async def process_input(self, user_message):
        ...
        try:
            llm_response = await self.provider.complete(prompt)
            ...
            if not next_question:
                next_question = self._generate_fallback_question(missing)
    ...
    def _handle_confirm(self, user_message):
    ...
    def _generate_fallback_question(self, missing):
        fallback = {
