...
- available_time: 출발 시간 HH:MM 형식 (예: "09:00")
- estimated_arrival_time: 도착 예정 시간 HH:MM 형식 (예: "10:40")
...
{{
  "extracted": {{
    ...
    "estimated_arrival_time": "추출한 값 또는 null",
    "waypoint": "추출한 값 또는 null"
  }},
  "next_question": "누락된 필드 중 첫 번째 하나에 대해서만 묻는 자연스러운 한국어 질문 또는 null. 반드시 한 가지만 질문할 것.",
