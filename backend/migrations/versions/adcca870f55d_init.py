...
Revision ID: adcca870f55d
Revises: 
Create Date: 2026-04-09 11:36:56.087757
...
def upgrade() -> None:
    ...
    op.create_index('idx_waypoints_geom', 'waypoints', ['geom'], unique=False, postgresql_using='gist')
    ...
    sa.Column('route', geoalchemy2.types.Geometry(geometry_type='LINESTRING', srid=4326, dimension=2, from_text='ST_GeomFromEWKT', name='geometry', nullable=False), nullable=False),
    sa.Column('available_date', sa.Date(), nullable=False),
    sa.Column('origin_area', sa.Text(), nullable=False),
    sa.Column('destination_area', sa.Text(), nullable=False),
    ...
    op.create_index('idx_volunteer_schedules_route', 'volunteer_schedules', ['route'], unique=False, postgresql_using='gist')
...
def downgrade() -> None:
    ...
    op.drop_index('idx_volunteer_schedules_route', table_name='volunteer_schedules', postgresql_using='gist')
    ...
    op.drop_index('idx_waypoints_geom', table_name='waypoints', postgresql_using='gist')
